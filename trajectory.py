...
class Trajectory:
    ...
    def estimate(self, frame_i, frame_i_1, vb):
    ...
    def localize(self, static_objects, vb):
        ...
        for i, j in itertools.combinations(range(N), 2):
            ...
            intersection = localize_two_circles(circle1, circle2, vb)
    ...
    def localize_two_circles(circle1, circle2, vb):
        '''
        ...
        Px1, Px2 = circle_intersection(circle1, circle2)
        ...
        if Px1==Px2:
            ...
            d1 = np.linalg.norm(Px1, np.inf)
            d2 = np.linalg.norm(Px2, np.inf)
            e1 = abs(d1-vb*T)
            e2 = abs(d2-vb*T)
            if e1<e2:
                return Px1
